...
function Set-LogConfiguration {
    ...
    if ($PSBoundParameters.ContainsKey('SendSyslog'))     { $Global:SendSyslog     = [bool]$SendSyslog }
    if ($PSBoundParameters.ContainsKey('JsonLogging'))    { $Global:JsonLogging    = [bool]$JsonLogging }
...
function Write-Log {
    ...
    if ($PSBoundParameters.ContainsKey('SendSysLog') -eq $false -and $Global:SendSyslog -ne $null) {
        $SendSysLog = [bool]$Global:SendSyslog
    }
    if ($PSBoundParameters.ContainsKey('OutputJson') -eq $false -and $null -ne $Global:JsonLogging) {
        $OutputJson = [bool]$Global:JsonLogging
    }
